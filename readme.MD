...
This module is developed for joindevops.com. We are creating following resources. This module creates resources in 
...
* vpc_cidr (Optional): Default values is 10.0.0.0/16. Type is string.
